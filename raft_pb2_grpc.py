...
class RaftNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AppendEntries = channel.unary_unary(
                ...
                _registered_method=True)
        self.ControlConnection = channel.unary_unary(
                '/RaftNode/ControlConnection',
                request_serializer=raft__pb2.ConnectionRequest.SerializeToString,
                response_deserializer=raft__pb2.ConnectionResponse.FromString,
                _registered_method=True)
...
class RaftNodeServicer(object):
    ...
    def ControlConnection(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RaftNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ControlConnection': grpc.unary_unary_rpc_method_handler(
                    servicer.ControlConnection,
                    request_deserializer=raft__pb2.ConnectionRequest.FromString,
                    response_serializer=raft__pb2.ConnectionResponse.SerializeToString,
            ),
...
class RaftNode(object):
    ...
    def ControlConnection(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/RaftNode/ControlConnection',
            raft__pb2.ConnectionRequest.SerializeToString,
            raft__pb2.ConnectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
